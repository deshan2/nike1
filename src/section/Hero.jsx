...
import { Button, Shoes } from "../components";
...
const Hero = () => {
  ...
  return (
    ...
    flex-col justify-center min-h-screen gap-10 max-container border-2 border-red-500 p-2"
    >
      <div
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-coral-red inline-block myt-3 py-4">Nike</span>
          Shoes
        </h1>
        <p
      ...
      <div
        className="relative fle-1 flex justify-center items-center xl:min-h-screen
max-xl:py-40 bg-primary bg-hero bg-cover bg-center"
  ...
  gap-4 absolute -bottom-[5%] sm:left-[10%] 
  max-sm:px-6"
        >
